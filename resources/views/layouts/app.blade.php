...
<head>
  ...
  <link href="{{ asset('assets/img/anjoo.png') }}" rel="apple-touch-icon">
        ...
        <div class="col-lg-2 col-md-4"></div>
          <div class="col-lg-6 col-md-12">
            <div class="footer-info">
              <h3>AJE Best-On Sdn Bhd<span style="font-size: 17px">&nbsp;(15952-A)</span></h3>
              ...
              <p style="font-size: 16px;">Website: <a href = "https://ajebest-on.com.my/" target="_blank"><span style="color: rgba(103, 176, 209, 0.8);"><u>https://ajebest-on.com.my/</u></span></a></p>
              <p style="font-size: 16px;">Email: <a href = "mailto: enquiry@ajebest-on.com.my"><span style="color: rgba(103, 176, 209, 0.8);"><u>enquiry@ajebest-on.com.my</u></span></a></p><br>
              </p>
            </div>
          </div>
