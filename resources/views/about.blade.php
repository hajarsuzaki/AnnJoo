                ...
                <div class="col-lg-12">
                    <div class="portfolio-info">
                        ...
                        <div class="row gy-12">
                            ...
                            <div class="col-lg-4">
                                <img src="assets/img/power_wagon.jpg" alt="" style="width: 400px; height: auto; border-radius: 25px;">
                            </div>
                            ...
                            <div class="row gy-12">
                                ...
                                <div class="col-lg-3">
                                    <img src="assets/img/aj_solar/aj_solar4.jpeg" alt="" style="width: 300px; height: auto; border-radius: 25px;">
                                </div>
                                <div class="col-lg-2"><br></div>
                                <div class="col-lg-3">
                                    <img src="assets/img/aj_solar/aj_solar9.jpeg" alt="" style="width: 300px; height: auto; border-radius: 25px;">
                                </div>
                                <div class="col-lg-2"></div>
                            </div><br>
                            <table>
                                <tr>
                                    <td width="50%">
                                        <p style="font-size: 16px; color: black; text-align: justify;">
                                            ...
                                            A parallel connection of basic modules enables single-phase and three-phase power supply. 70% automatic problem-preventive system with battery 
                                            DOD (Depth of Discharge) setting (Enable to restart after 5 ~ 10 minutes from insufficient to sufficient battery power level). Engine stops when the 
                                            vehicle stops and restarts when the vehicle starts (Inventers running only when loading).
                                        </p>
                                    </td>
                                    <td>&nbsp;&nbsp;</td>
                                    <td>&nbsp;&nbsp;</td>
                                    <td>
                                        <p style="font-size: 16px; color: black; text-align: justify;">
                                            No heating or cooling systems required and low EMR (electromagnetic radiation) on solar cells, batteries, and inverter equipment. Easy operation with automatic design, very low parts replacement, and 
                                            low maintenance cost for use in independent power grid (easy to follow up power load). Reduced site requirement by 90% compared to the same power 
                                            generation with conventional Solar PV deployment, easy to install, and easy expansion.<br><br><br><br>
                                        </p>
                                    </td>
                                </tr>
                            </table>
